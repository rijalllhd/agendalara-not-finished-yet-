...
<h2 class="text-lg font-semibold ml-2 pb-4">MATA PELAJARAN</h2>
    ...
    <div id="createModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        ...
        <p class="flex justify-center font-light text-sm mb-4">Tambahlah data dengan informasi yang sebenar-benarnya</p>
            <form class="px-4 py-2 left-1/2">
                <label for="" class="right-2 mb-1">Kode Mata Pelajaran</label><br>
                    <input type="text" name="" value="" placeholder="Kode Mata Pelajaran" class="p-2 w-full bg-slate-100 rounded-md mb-3">

                <label for="" class="right-2 mb-1">Mata Pelajaran</label><br>
                    <input type="text" name="" value="" placeholder="Nama Mata Pelajaran" class="p-2 w-full bg-slate-100 rounded-md mb-3">
            </form>
    ...
    <script>
        ...
        window.location.href = '{{ url('/mapel') }}';
        //   location.reload();
        });
