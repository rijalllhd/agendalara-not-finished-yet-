...
<div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
  <div class="w-full max-w-md space-y-8">
    <form class="mt-8 space-y-6" action="{{ route('guru.login') }}" method="POST">
      @csrf
      ...
      <div class="text-sm">
        <a href="{{ route('guru.register') }}" class="font-medium text-indigo-600 hover:text-indigo-500">REGISTER</a>
      </div>
